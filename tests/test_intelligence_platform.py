...
class IntelligencePlatformTests(unittest.TestCase):
    ...
    def test_all_four_registered_providers_produce_one_recommendation(self) -> None:
        ...
        self.assertEqual(self.orchestrator.registry.names(), ("decision", "asset", "front_office", "trade"))
        self.assertEqual(set(result.recommendation.sources), {"Decision Engine", "Asset Intelligence", "Trade Intelligence", "Front Office Intelligence"})
    ...
    def test_platform_health_and_unified_api_are_additive(self) -> None:
        ...
        self.assertEqual(set(health.json()["engines"]), {"decision", "asset", "front_office", "trade"})
    ...
    def test_health_exposes_cache_namespaces_and_engine_timings(self) -> None:
        ...
        self.assertTrue({"league", "assets", "front_offices", "trades", "result"}.issubset(health["cache"]["namespaces"]))
        self.assertTrue({"decision_engine", "asset_intelligence", "front_office_intelligence", "trade_intelligence", "orchestration_total"}.issubset(health["orchestration"]["last_timings_ms"]))
