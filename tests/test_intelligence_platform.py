...
class IntelligencePlatformTests(unittest.TestCase):
    ...
    def test_platform_health_and_unified_api_are_additive(self) -> None:
        ...
        self.assertEqual(set(health.json()["engines"]), {"decision", "asset", "front_office", "trade", "market", "roster"})
    ...
    def test_health_exposes_cache_namespaces_and_engine_timings(self) -> None:
        ...
        self.assertTrue({"league", "assets", "front_offices", "trades", "market", "roster", "result"}.issubset(health["cache"]["namespaces"]))
        self.assertTrue({"decision_engine", "asset_intelligence", "front_office_intelligence", "trade_intelligence", "market_intelligence", "roster_intelligence", "orchestration_total"}.issubset(health["orchestration"]["last_timings_ms"]))
