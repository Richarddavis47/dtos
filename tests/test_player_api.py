...
class PlayerApiContractTests(unittest.TestCase):
    ...
    def test_valid_dossier_url_and_missing_id_behavior(self) -> None:
        ...
        self.assertIn("canonical_evidence for season-scoped production", valid.text)
        self.assertNotIn("No supported production-stat provider is configured", valid.text)
