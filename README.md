...
DTOS v1.3.0 adds League Intelligence Engine v1. Shared roster, player-value, market, decision, trade, and observable Front Office evidence now produces deterministic team needs, surpluses, directions, league economy, trade compatibility, asset availability, and prioritized opportunities through the Intelligence Orchestrator.
...
See [League Intelligence](docs/LEAGUE_INTELLIGENCE.md), [Market Intelligence](docs/MARKET_INTELLIGENCE.md), [Intelligence Platform](docs/INTELLIGENCE_PLATFORM.md), [Trade Intelligence](docs/TRADE_INTELLIGENCE.md), [Asset Intelligence](docs/ASSET_INTELLIGENCE.md), [Decision Philosophy](docs/DTOS_DECISION_PHILOSOPHY.md), [Commissioner Desk architecture](docs/CommissionerDesk.md), [DTOS philosophy](DTOS_PHILOSOPHY.md), [roadmap](ROADMAP.md), and [release notes](RELEASE_NOTES.md).
