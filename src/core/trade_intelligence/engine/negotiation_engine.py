...
from src.core.trade_intelligence.models import NegotiationPlan, TradeProposal
...
def build_negotiation_plan(proposal: TradeProposal, alternatives: tuple[str, ...]) -> NegotiationPlan:
    ...
    return NegotiationPlan(
        ...
        "Expect the partner to request the highest-value flexible asset in the proposed package or an equivalent pick adjustment.",
        ...
        alternatives,
        ("Confirm current NFL news before negotiating.", "Do not treat the generated package as evidence of partner willingness.", "The GM approves every message and roster move."),
    )
