...
.status-trophy{display:inline-flex;gap:7px;align-items:center;color:var(--gold);font-weight:950;text-transform:uppercase;letter-spacing:.08em}.status-trophy:before{content:"🏆"}.status-hot{display:inline-flex;gap:6px;align-items:center;color:#ff8a52;font-weight:900}.status-hot:before{content:"🔥"}
