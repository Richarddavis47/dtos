...
def _public_team_intelligence(card: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "competitive_window": {
            "classification": card.competitive_window.classification.value,
            "confidence": card.competitive_window.confidence,
            "championship_score": card.competitive_window.championship_score,
            "playoff_score": card.competitive_window.playoff_score,
            "rebuild_score": card.competitive_window.rebuild_score,
            "reasons": list(card.competitive_window.reasons),
            "strengths": list(card.competitive_window.strengths),
            "weaknesses": list(card.competitive_window.weaknesses),
            "generated_at": card.competitive_window.generated_at,
            "version": card.competitive_window.version,
        },
