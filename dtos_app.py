"""DTOS v0.8.0 Architecture Bridge — modular project foundation.
...
async def sync_sleeper(force_players: bool = False) -> dict[str, Any]:
    ...
    async with SYNC_LOCK:
        ...
        try:
            ...
            headers = {"User-Agent": "DTOS/0.8.0 (+Day Traders)"}
...
app = FastAPI(title="DTOS", version="0.8.0", lifespan=lifespan)
